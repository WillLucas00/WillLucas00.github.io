...
gdjs.DevCode.GDCogButtonObjects1= [];
gdjs.DevCode.GDCogButtonObjects2= [];
gdjs.DevCode.GDCogButtonObjects3= [];
...
gdjs.DevCode.GDCogObjects1= [];
gdjs.DevCode.GDCogObjects2= [];
gdjs.DevCode.GDCogObjects3= [];
...
};gdjs.DevCode.mapOfGDgdjs_46DevCode_46GDlevelOnOffObjects1Objects = Hashtable.newFrom({"levelOnOff": gdjs.DevCode.GDlevelOnOffObjects1});gdjs.DevCode.mapOfGDgdjs_46DevCode_46GDlevelOnOffObjects1Objects = Hashtable.newFrom({"levelOnOff": gdjs.DevCode.GDlevelOnOffObjects1});gdjs.DevCode.eventsList1 = function(runtimeScene) {
...
gdjs.DevCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9264644);
}
}}
if (gdjs.DevCode.condition1IsTrue_0.val) {
...
gdjs.DevCode.condition0IsTrue_0.val = false;
{
gdjs.DevCode.condition0IsTrue_0.val = gdjs.evtTools.input.wasKeyReleased(runtimeScene, "c");
}if (gdjs.DevCode.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("CogButton"), gdjs.DevCode.GDCogButtonObjects1);
gdjs.DevCode.GDlevelOnOffObjects1.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.DevCode.mapOfGDgdjs_46DevCode_46GDlevelOnOffObjects1Objects, (( gdjs.DevCode.GDCogButtonObjects1.length === 0 ) ? 0 :gdjs.DevCode.GDCogButtonObjects1[0].getPointX("Center")), (( gdjs.DevCode.GDCogButtonObjects1.length === 0 ) ? 0 :gdjs.DevCode.GDCogButtonObjects1[0].getPointY("Center")), "");
...
gdjs.DevCode.GDCogButtonObjects1.length = 0;
gdjs.DevCode.GDCogButtonObjects2.length = 0;
gdjs.DevCode.GDCogButtonObjects3.length = 0;
...
gdjs.DevCode.GDCogObjects1.length = 0;
gdjs.DevCode.GDCogObjects2.length = 0;
gdjs.DevCode.GDCogObjects3.length = 0;
